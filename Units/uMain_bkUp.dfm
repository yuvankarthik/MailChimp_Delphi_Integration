object Form6: TForm6
  ...
  object pnlList: TPanel
    ...
    object MailChimpLists: TListBox
      Left = 8
      Top = 88
      Width = 152
      Height = 139
  ...
  object pnlCampaign: TPanel
    ...
    Caption = 'pnlCampaign'
    TabOrder = 2
    object MailChimpListCampaign: TListBox
      Left = 1
      Top = 53
      Width = 318
      Height = 97
    ...
    object btnLoadToCampaing: TButton
      ...
      TabOrder = 4
      OnClick = btnLoadToCampaingClick
    end
  ...
  object pnlExacute: TPanel
    ...
    Caption = 'pnlExacute'
    TabOrder = 3
    object MailChimpList2: TListBox
      Left = 16
      Top = 15
      Width = 105
      Height = 91
    ...
    object MailChimpCampaign2: TListBox
      Left = 135
      Top = 18
      Width = 161
      Height = 87
  ...
  object ListFDMemTable: TFDMemTable
    Active = True
    FieldDefs = <
      item
        Name = 'LASTNAME'
    ...
    Top = 37
    Content = {
      414442530F006B17D4030000FF00010001FF02FF03040016000000460044004D
